...
extern "C" {
#endif
SWIGINTERN int Swig_var_Solution_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_class,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""Solution""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""Solution""' of type '""class""'");
    } else {
      Solution = *((class *)(argp));
    }
  }
...
SWIGINTERN PyObject *Swig_var_Solution_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&Solution), SWIGTYPE_p_class,  0 );
  return pyobj;
}
...
# endif
  ...
  SWIG_addvarlink(globals, "Solution", Swig_var_Solution_get, Swig_var_Solution_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
